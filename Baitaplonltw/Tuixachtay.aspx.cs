...
{
    public partial class Tuisachtay : System.Web.UI.Page
    {
        [WebMethod]
        ...
        public static List<SanPhamDTO> FilterProductsByPrice(string priceRange)
        {
            ...
            var result = ds
                .Where(sp => sp.Loai == "TuiXachTay" && sp.Gia >= min && sp.Gia <= max)
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                rptbontxt.DataBind();
                var id4 = new List<string> { "TXT05", "TXT06", "TXT07", "TXT08" };
                var ds4 = ds.Where(sp => id4.Contains(sp.ID)).ToList();
                rptbontxt2.DataSource = ds4;
                rptbontxt2.DataBind();
            }
        }
