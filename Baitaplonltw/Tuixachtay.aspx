<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Tuixachtay.aspx.cs" Inherits="Baitaplonltw.Tuisachtay" %>
...
<body>
   ...
   <div class="header-container">
       ...
       <asp:Label ID="lblChao" runat="server" class="xinchao"/>
            ...
            <p class="trangchu-cater">Trang chủ   |   Túi xách tay</p>
               ...
               <asp:Repeater ID="rptbontxt" runat="server">
                   <ItemTemplate>
                       <div class="product-card">
                        ...
                        <div class="product-container">
               <asp:Repeater ID="rptbontxt2" runat="server">
                   <ItemTemplate>
                       <div class="product-card">
                           <a href='<%# "Chitiet.aspx?id=" + Eval("ID") %>'>
                               <img src='<%# Eval("Anh") %>' alt="Ảnh" class="product-img" />
