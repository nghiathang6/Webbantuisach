<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Donhang.aspx.cs" Inherits="Baitaplonltw.Donhang" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Đơn hàng của bạn</title>
    <link href="cssdonhang.css" rel="stylesheet" />
                            ...
                            <td>
                                <ul class="sanpham-list">
                                    <asp:Repeater ID="rptSP" runat="server">
                                        <ItemTemplate>
                                            <li>
                                                <%# Eval("Ten") %> - SL: <%# Eval("SoLuong") %> - Giá: <%# Eval("Gia", "{0:N0}") %> đ - Thành tiền: <%# Eval("ThanhTien", "{0:N0}") %> đ
                                            </li>
                                        </ItemTemplate>
                                    </asp:Repeater>
                                </ul>
                                <br />
                                <strong>Tổng tiền: 
                                    <%# ((List<Baitaplonltw.SanPhamGioHang>)Eval("SanPham"))
                                        .Sum(sp => sp.Gia * sp.SoLuong).ToString("N0") %> đ
                                </strong>
                            </td>
                            <td><%# Eval("TrangThai") %></td> <!-- thêm -->
                        </tr>
                    </ItemTemplate>
