<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Tuideocheo.aspx.cs" Inherits="Baitaplonltw.Tuideocheo" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Túi đeo chéo</title>
   ...
   <div class="header-container">
       ...
       <div class="user-menu">
           ...
           <asp:Label ID="lblChao" runat="server" class="xinchao" Text=""/>
            ...
            <p class="trangchu-cater">Trang chủ   |   Túi đeo chéo</p>
            ...
            <div class="product-container">
               <asp:Repeater ID="rptbontdc2" runat="server">
                   <ItemTemplate>
                       <div class="product-card">
                           <a href='<%# "Chitiet.aspx?id=" + Eval("ID") %>'>
                               <img src='<%# Eval("Anh") %>' alt="Ảnh" class="product-img" />
    ...
    <script>
        function filterByPrice() {
            ...
            fetch('Tuideocheo.aspx/FilterProductsByPrice', {
                method: 'POST',
            ...
            <div class="product-card">
                ...
                <div class="product-price">${p.Gia.toLocaleString('vi-VN')} đ</div>  <!-- Hiển thị giá -->
            </div>`;
                    });
                })
